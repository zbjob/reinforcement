...
.. py:class:: mindspore_rl.core.Session
    ...
    **参数：**
    ...
    - **config** (dict) - 算法的配置或算法的部署配置。更多算法配置的详细信息，请看 
      https://www.mindspore.cn/reinforcement/docs/zh-CN/master/custom_config_info.html

    .. py:method:: run(class_type=None, is_train=True, episode=0, params=None, callbacks=None)
        ...
        **参数：**
        ...
        - **is_train** (bool) - 在训练或推理中执行算法。默认值： True。
