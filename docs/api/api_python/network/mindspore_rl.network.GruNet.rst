...
.. py:class:: mindspore_rl.network.FullyConnectedNet(input_size, hidden_size, weight_init='normal', num_layers=1, has_bias=True, batch_first=False, dropout=0.0, bidirectional=False)
